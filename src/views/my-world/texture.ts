export const templateVertexShader = `
varying vec2 vUv;
...
`;
export const templateFragmentShader = `
uniform float uTime;
uniform vec2 uMouse;
...
`;
export const sunNoiseVertexShader = `
#define GLSLIFY 1
varying vec2 vUv;
...
`;
export const sunNoiseFragmentShader = `
#define GLSLIFY 1
//
...
`;
export const sunShapeVertexShader = `
#define GLSLIFY 1
...
`;
export const sunShapeFragmentShader = `
#define GLSLIFY 1
...
`;
export const sunRingVertexShader = `
#define GLSLIFY 1
varying vec2 vUv;
varying vec3 vPosition;
...
`;
export const sunRingFragmentShader = `
#define GLSLIFY 1
