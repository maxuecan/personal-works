...
function runCode() {
    ...
    var myPromise = Sk.misceval.asyncToPromise(function () {
        console.log(Sk.TurtleGraphics, 'mxc')
        return Sk.importMainWithBody('<stdin>', false, code, true); // 运行代码
    })
...
<template>
    <div>
        <textarea id="editor-code" style="border:0;border-radius:5px;background-color:rgba(241,241,241,.98);width: 100%;height: 200px;padding: 10px;resize: none;">
import turtle
print('hello')
t = turtle.Turtle()
t.color('red')
t.forward(75)
        ...
        <div id="mycanvas" width="600" height="600"></div>
    </div>
</template>
